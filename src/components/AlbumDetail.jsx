...
const AlbumDetail = () => {
  ...
  useEffect(() => {
    // Sayfa yüklendiğinde localStorage'dan beğenilen parçaları al
  ...
  return (
    <div className='album-all'>
      ...
      <div className='album-main'>
        ...
        <div className="resultContainer like-list album-twoP">
          ...
          <ul>
            ...
            <li key={track.id}>
              <div key={track.id} className="resultBox search-result-item album-resultB">
